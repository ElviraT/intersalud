<div id="modal_civil" class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" data-consulta="{{ action('Admin\configuracion\CivilController@edit') }}">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            {!! Form::open(['route' => ['civil.add'],  'method' => 'post', 'class' => 'needs-validation', 'novalidate' ]) !!}
