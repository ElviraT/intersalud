                ...
                <div class="col-md-12">
                    <div class="row">                        
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="numero" class="form-control" id="numero" placeholder="Número de cuenta" required autofocus="true" maxlength="20" onkeypress="return SoloNumeros(event)">
                        </div>
                        <div class="col-md-6 mb-3">
