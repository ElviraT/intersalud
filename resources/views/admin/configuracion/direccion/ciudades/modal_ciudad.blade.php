<div id="modal_ciudad" class="modal fade bd-example-modal-sm" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" data-consulta="{{ action('Admin\configuracion\direccion\CiudadController@edit') }}">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            {!! Form::open(['route' => ['ciudad.add'],  'method' => 'post', 'class' => 'needs-validation', 'novalidate', 'id'=>'registra_ciudadForm']) !!}
            <div class="modal-body">
                ...
                <div class="col-md-12 mb-3">
                    <label>{{'Capital'}}</label>
                    <input type="checkbox" name="capital" id="capital" data-toggle="toggle"  data-on="Si" data-off="No" data-size="xs"> 
                </div>
            </div>
