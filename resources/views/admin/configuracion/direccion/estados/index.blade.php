...
<div class="col-md-4">
  <ul class="breadcrumb-title">
      <li class="breadcrumb-item">
          <a href="{{ route('estado')}}" onclick="loading_show();"> <i class="fa fa-home"></i> </a>
      </li>
                    ...
                    <tbody>
                      @foreach($estados as $resultado)
                        <tr>
                            ...
                            <td width="20">
                                <a href="#" type="button" data-toggle="modal" data-target="#modal_estado" class="btn-transition btn btn-outline-success" data-record-id="{{ $resultado['id_Estado'] }}" onclick="loading_show();">
                                    <span class="btn-icon-wrapper pr-2 opacity-7">
                                        <i class="ti-pencil"></i>
                                    </span>
                                    {{'Editar'}}
                                ...
                                <a href="#" type="button" data-toggle="modal" data-target="#confirm-delete2" data-record-id="{{$resultado->id_Estado}}" data-record-title="{{$resultado->Estado}}" class="btn-transition btn btn-outline-danger" onclick="loading_show();">
                                        <span class="btn-icon-wrapper pr-2 opacity-7">
                                            <i class="ti-eraser"></i>
                                        </span>{{'Eliminar'}}
                                </a>
