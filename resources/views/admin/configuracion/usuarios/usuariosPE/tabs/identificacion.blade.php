    ...
    <div class="form-group col-md-12">
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="parentesco" class="form-control" id="Parentesco" placeholder="parentesco" required value="{{ isset($paciente) ? $paciente->Apellidos_Paciente : null }}">
            </div>
            <div class="col-md-6 mb-3">
                ...
                <label>{{ 'Fecha de nacimiento' }}</label>
                  <div class="input-group">
                    <div class="input-group-prepend">
                     ...
                     {!!
                         Form::text('fechNacPE', isset($paciente) ? $paciente->Fecha_Nacimiento_Paciente : null, [
                             'id' => 'fechNacPE',
                             'placeholder'=>'Y-M-D',
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="checkbox" name="pi" id="pi" data-toggle="toggle"  data-on="Si" data-off="No" data-size="xs" class="form-control checkbox"> 
            </div>
            <div class="col-md-6 mb-3">
                <label>{{'Paciente Mayor'}}</label>
                <input type="checkbox" name="pm" id="pm" data-toggle="toggle"  data-on="Si" data-off="No" data-size="xs" class="form-control checkbox"> 
            </div>
            <div class="col-md-6 mb-3">
                <label>{{'Tiene Discapacidad'}}</label>
                <input type="checkbox" name="pd" id="pd" data-toggle="toggle"  data-on="Si" data-off="No" data-size="xs" class="form-control checkbox"> 
            </div>
            <div class="col-md-6 mb-3">
                <label>{{'Nota'}}</label>
