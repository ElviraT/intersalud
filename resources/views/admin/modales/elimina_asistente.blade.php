<div class="modal fade" id="confirm-delete16" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {!! Form::open(['action' => ['Admin\configuracion\usuarios\UsuarioAController@destroy'], 'id'=>'form_usuariosA_eliminar']) !!}
                {{ Form::hidden('id', null, ['id'=>'modal_registo_usuariosA_id'] ) }}
