    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {!! Form::open(['action' => ['Admin\configuracion\direccion\CiudadController@destroy'], 'id'=>'form_ciudad_eliminar']) !!}
                {{ Form::hidden('id', null, ['id'=>'modal_registo_ciudad_id'] ) }}

                    <p>Vas a eliminar la ciudad <b><i class="title"></i></b>, este proceso es irreversible.</p>
