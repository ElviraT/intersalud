<div class="modal fade" id="confirm-delete28" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {!! Form::open(['action' => ['Admin\configuracion\usuarios\UsuarioPEController@destroy'], 'id'=>'form_usuariosPE_eliminar']) !!}
                {{ Form::hidden('id', null, ['id'=>'modal_registo_usuariosPE_id'] ) }}
