    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                {!! Form::open(['action' => ['Admin\configuracion\direccion\PaisController@destroy'], 'id'=>'form_pais_eliminar']) !!}
            <div class="modal-body">
                {{ Form::hidden('id', null, ['id'=>'modal_registo_pais_id'] ) }}

                    <p>Vas a eliminar el país <b><i class="title"></i></b>, este proceso es irreversible.</p>
