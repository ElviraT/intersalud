    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                {!! Form::open(['action' => ['Admin\configuracion\PrefijoDniController@destroy'], 'id'=>'form_prefijo_eliminar']) !!}
            <div class="modal-body">
                {{ Form::hidden('id', null, ['id'=>'modal_registo_prefijo_id'] ) }}

                    <p>Vas a eliminar el prefijo <b><i class="title"></i></b>, este proceso es irreversible.</p>
