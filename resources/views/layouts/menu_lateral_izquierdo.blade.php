<nav class="pcoded-navbar">
  ...
  <div class="pcoded-inner-navbar main-menu">
    ...
    @canany(['pais','estado','ciudad','municipio','parroquia','prefijo','sexo','civil','status_m','status_c','status_f','status_t','status','usuario_m','usuario_a','usuario_p','usuario_pe','usuario_g','banco','cuentaUSD','tipoC','entidad','cripto','billetera','cuenta_banco','tpago','especialidad','consultorio','controlE'])
      <ul class="pcoded-item pcoded-left-item">
            ...
            <ul class="pcoded-submenu">
              ...
              @canany(['prefijo','sexo','civil'])
                <li class="{{ @request()->routeIs('prefijo') || @request()->routeIs('sexo') || @request()->routeIs('civil') ? 'active pcoded-hasmenu pcoded-trigger' : 'pcoded-hasmenu' }}">
                    <a href="javascript:void(0)" class="waves-effect waves-dark">
                          <span class="pcoded-micon"><i class="ti-direction-alt"></i></span>
                          <span class="pcoded-mtext" data-i18n="nav.menu-levels.menu-level-22.main">{{'Config. Personas'}}</span>&nbsp;
                          <span class="pcoded-mcaret"></span>
                      </a>
              ...
              @canany(['usuario_m','usuario_a','usuario_p','usuario_pe','usuario_g'])
                <li class="{{ @request()->routeIs('usuario_m*') || @request()->routeIs('usuario_a*') || @request()->routeIs('usuario_p*') || @request()->routeIs('usuario_pe*') || @request()->routeIs('usuario_g*') ? 'active pcoded-hasmenu pcoded-trigger' : 'pcoded-hasmenu' }}">
                      <a href="javascript:void(0)" class="waves-effect waves-dark">
                          <span class="pcoded-micon"><i class="ti-direction-alt"></i></span>
                          <span class="pcoded-mtext" data-i18n="nav.menu-levels.menu-level-22.main">{{'Usuarios'}}</span>
                          <span class="pcoded-mcaret"></span>
                      </a>
                      <ul class="{{ @request()->routeIs('usuario_m*') || @request()->routeIs('usuario_a*') || @request()->routeIs('usuario_p*') || @request()->routeIs('usuario_pe*') || @request()->routeIs('usuario_g*') ? 'active pcoded-submenu pcoded-trigger' : 'pcoded-submenu' }}">
                        @can('usuario_g')
                        ...
                        @endcan
                        @can('usuario_p')
                          <li class="{{ @request()->routeIs('usuario_p*') || @request()->routeIs('usuario_pe*') ? 'active' : ''}}">
                       ...
                       @can('banco')
                        ...
                        @can('tipoC')
                          <li class="{{ @request()->routeIs('tipoC') ? 'active' : ' ' }}">
                              <a href="{{ route('tipoC')}}" onclick="loading_show();" class="waves-effect waves-dark">
                                  <span class="pcoded-micon"><i class="ti-minus"></i><b>TC</b></span>
                                  <span class="pcoded-mtext" data-i18n="nav.dash.main">{{'Tipo de Cuenta'}}</span>
                                  <span class="pcoded-mcaret"></span>
                              </a>
                          </li>
                        @endcan
                      ...
                      <ul class="{{ @request()->routeIs('especialidad') || @request()->routeIs('consultorio') || @request()->routeIs('controlE') ? 'active pcoded-submenu pcoded-trigger' : 'pcoded-submenu' }}">
                       @can('especialidad')
                        ...
                        <li class="{{ @request()->routeIs('controlE') ? 'active' : ' ' }}">
                            <a href="{{ route('controlE')}}" onclick="loading_show();" class="waves-effect waves-dark">
                                <span class="pcoded-micon"><i class="ti-minus"></i><b>CM</b></span>
                                <span class="pcoded-mtext" data-i18n="nav.dash.main">{{'Control Especialidades'}}</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        </li>
                        @endcan
        ...
        <li class="{{ @request()->routeIs('reporte_consulta') || @request()->routeIs('facturaH') || @request()->routeIs('cservicios') ? 'active pcoded-hasmenu pcoded-trigger' : 'pcoded-hasmenu' }} ">
            ...
            <ul class="pcoded-submenu">
              <li class="{{ @request()->routeIs('facturaH') ? 'active' : ''}}">
                <a href="{{ route('facturaH')}}" onclick="loading_show();" class="waves-effect waves-dark">
                  <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                  <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">{{'Histórico de Factura'}}</span>
                  <span class="pcoded-mcaret"></span>
                </a>
              </li>
            </ul>
